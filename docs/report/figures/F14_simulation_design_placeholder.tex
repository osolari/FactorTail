...
\node[align=center, font=\large] at (6,5.65) {\textbf{Simulation dashboard}};
...
\node[align=left, text width=10.8cm, font=\small] at (6,2.7) {\textbf{Source CSV:} \texttt{results/F14\_simulation\_dashboard.csv}\\
\textbf{Required columns:} \texttt{family, estimator, threshold, rel\_error, wnre, runtime}};
