...
\caption[Empirical design matrix (partial)]{\textbf{(PARTIAL.)} Planned
...
\caption[Real-data panels (planned)]{\textbf{(PLANNED).} Real-data panels
...
\caption[Real-data tail-index estimates (planned)]{\textbf{(PLANNED).}
Tail-index estimates for signed factor and residual contributions. Values are
...
\caption[Hill and POT stability (planned)]{\textbf{(PLANNED).} Hill and POT
...
\caption[Tail-dependence diagnostics (planned)]{\textbf{(PLANNED).}
Tail-dependence diagnostics for factor and residual loss contributions.
...
\caption[Tail-dependence heatmap (planned)]{\textbf{(PLANNED).}
Tail-dependence heatmap. The generated figure will show pairwise \(\chi\),
...
\caption[Rolling spectral measure (planned)]{\textbf{(PLANNED).} Rolling
...
\caption[VaR and ES forecast dashboard (planned)]{\textbf{(PLANNED).} VaR/ES
...
\caption[VaR and ES backtest (planned)]{\textbf{(PLANNED).} VaR and ES
...
\caption[Crisis attribution (planned)]{\textbf{(PLANNED).} Crisis-window
...
\caption[Real-data experiment registry (partial)]{\textbf{(PARTIAL.)}
Planned real-data experiment registry. Experiment descriptors, estimator
...
\caption[Runtime (planned)]{\textbf{(PLANNED).} Runtime and
