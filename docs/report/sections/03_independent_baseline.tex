...
\input{figures/F2_max_vs_sum.tex}
\input{figures/F3_exp_eff_vs_x.tex}
\input{figures/F4_exp_eff_vs_alpha.tex}
\input{figures/F5_exp_eff_vs_amin.tex}
\input{figures/F6_relative_error.tex}
\input{figures/F7_stratified.tex}
