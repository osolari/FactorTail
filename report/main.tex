...
\hypersetup{
  pdftitle={Conditional Monte Carlo for Multivariate Heavy Tails: Latent Shocks, Spectral Measures, Hidden Cones},
...
\input{sections/01b_literature_and_positioning.tex}
\input{sections/02_setup_and_notation.tex}
\input{sections/03_independent_baseline.tex}
\input{sections/04_dependent_cdmcs.tex}
\input{sections/05_mrv_spectral.tex}
\input{sections/06_hidden_regular_variation.tex}
\input{sections/07_estimators_and_efficiency.tex}
\input{sections/08_simulation_study.tex}
\input{sections/09_real_data_analysis.tex}
\input{sections/10_discussion.tex}

\bibliography{references}

\appendix
\input{appendices/A_notation.tex}
\input{appendices/B_independent_proofs.tex}
\input{appendices/C_dependent_proofs.tex}
\input{appendices/D_second_order_and_hidden_rv.tex}
\input{appendices/E_algorithms_and_pseudocode.tex}
\input{appendices/F_data_specs.tex}
\input{appendices/G_experiment_manifest.tex}
